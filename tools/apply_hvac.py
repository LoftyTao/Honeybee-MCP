...
def apply_hvac(
    ...
    Supports advanced Radiant HVAC configuration.
    
    Args for Radiant Systems (HeatCool/DOAS):
        radiant_type: 'Floor', 'Ceiling', 'FloorWithCarpet', 'CeilingMetalPanel', 'FloorWithHardwood'.
        radiant_switch_over_time: Hours before switching between heating/cooling (Default 24).
    """
